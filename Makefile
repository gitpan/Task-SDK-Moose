# This Makefile is for the Task::SDK::Moose extension to perl.
#
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Task/SDK/Moose.pm
...
TO_INST_PM = lib/Task/SDK/Moose.pm

PM_TO_BLIB = lib/Task/SDK/Moose.pm \
	blib/lib/Task/SDK/Moose.pm
...
manifypods : pure_all  \
	lib/Task/SDK/Moose.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Task/SDK/Moose.pm $(INST_MAN3DIR)/Task::SDK::Moose.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Task/SDK/Moose.pm blib/lib/Task/SDK/Moose.pm 
